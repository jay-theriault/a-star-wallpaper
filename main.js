...
if (typeof window !== 'undefined') {
  ...
  function ensureGraphProjection(w, h) {
    ...
    const proj = makeProjector(simBounds, w, h);
  ...
  function buildCoastlineMask(w, h) {
    ...
    const maskProj = makeProjector(simBounds, mw, mh);
  ...
  function buildLandLayer(lctx, w, h) {
    ...
    const landProj = makeProjector(simBounds, w, h);
  ...
  function buildRoadsLayer(rctx, w, h) {
    ...
    const roadsProj = makeProjector(simBounds, w, h);
    let segments = 0;
